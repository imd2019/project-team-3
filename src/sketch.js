...
window.addEventListener("addAction", function (ev) {
  player.addAction(ev.detail.origin, ev.detail.name, ev.detail.data);
});

let game = new Game(player);
window.addEventListener("enterView", function (ev) {
...
function setupGame() {
  ...
  let kioskSunshade = new InteractiveObject(
    859,
    240,
    500,
    400,
  ...
  let kioskTrashcan = new InteractiveObject(
    300,
    528,
    101,
    110,
  ...
  let coffeeHouseForegnd = new InteractiveObject(
    0,
    0,
    1792,
    768,
  ...
  let demoForegnd = new DualBackgndSprite(
    -160,
    -6,
    2180,
    845,
  ...
  let demoSignsLeft = new InteractiveObject(
    214,
    215,
    1315,
    322,
  ...
  let demoSignsRight = new InteractiveObject(
    268,
    226,
    1311,
    313,
